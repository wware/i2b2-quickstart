...
/**
 * <p>Java class for eidType complex type.
 * 
...
@XmlType(name = "eidType", propOrder = {
    "eventId",
    "eventMapId"
})
public class EidType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the eventMapId property.
     * 
     * <p>
     ...
     * {@link EidType.EventMapId }
     * 
     * 
     */
    public List<EidType.EventMapId> getEventMapId() {
        if (eventMapId == null) {
            eventMapId = new ArrayList<EidType.EventMapId>();
        }
    ...
    public static class EventId {
        ...
        @XmlAttribute(name = "patient_id_source")
         ...
         *     
         */
        public void setPatientIdSource(String value) {
            this.patientIdSource = value;
        }
    ...
    public static class EventMapId {
