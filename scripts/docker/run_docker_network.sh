...
sudo docker stop i2b2-web; sudo docker rm i2b2-web;
...
sudo docker run -d  -p 443:443 -p 80:80 --net i2b2-net --name i2b2-web i2b2/i2b2-web:0.95 /run-httpd.sh 192.168.254.147
